...
public class Analyzer { //клас для атаки
    String text;
    ...
    public Analyzer(String text) { // конструктор класу
        /**
         * конструктор класу
         * читання тексту або файлу
         */
        if (text.length() < 40) {
            try {
        ...
        // отримання 10 найчастіших біграм шифрованого тексту
    ...
    /**
     * пошук пар a та b
     * @return ArrayList<ArrayList<Integer>> - список пар a, b
     */
    public ArrayList<ArrayList<Integer>> solve(){
        ...
        // пошук пар по сформованим спискам
    ...
    /**
     *
     * @param (a, b) - можливий ключ, знайдений в solve
     * @return - строка, розшифрована ключами (a, b)
     */
    ...
    /**
     *
     * @param bigrams - список біграм
     * @return - список номерів біграм
     */
